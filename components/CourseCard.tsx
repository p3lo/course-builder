...
const CourseCard: React.FC<{ course: FullCourse }> = ({ course }) => {
  ...
  return (
    <div className="relative space-y-1 h-[320px] cursor-pointer hover:shadow-md">
      <div className="h-40 overflow-hidden border w-60">
        <Image
          src={
            course.image
              ? course.image
      ...
      <h2 className="absolute p-1 text-xs font-bold bg-red-200">Bestseller</h2>
    </div>
  );
};
